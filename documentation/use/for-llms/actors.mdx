...
description: "How Autonomy was architected to be able to run agents at embarrassingly parallel scale."
---
...
A relative comparison of overhead, startup latency, and statefulness.

- Actors: minimal overhead, near-instant startup, inherently stateful.
...
How many instances can realistically run per (generic) server:
...
- We can run **millions of agents on commodity hardware** without drowning in overhead.
...
- Developers / Customers can focus on _what the agent should do_, not how to manage the complexity of containers, schedulers, or serverless architectures.
