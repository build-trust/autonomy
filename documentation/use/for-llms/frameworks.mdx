...
description: "Many developer have started to build prototypes with a framework like LangChain, CrewAI, or LlamaIndex. These tools are great for creating scripts, but they are just one of many tools you need to get your agent into production at scale. Here we will discuss what else is needed"
---

[This post was originally published on Autonomy's LinkedIn Page:](https://www.linkedin.com/pulse/agents-arent-products-autonomy-computer-hazlc/) 
