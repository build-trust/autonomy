...
description: "We frequently have analysts ask us about Autonomy. This document represents a typical Q&A with an analyst and provides examples of awards that Autonomy has won from analyst firms."
---
...
## Analyst coverage and awards received by Autonomy.

Autonomy has received several innovation awards since it's release.

### Intellyx

Intellyx is a boutique industry analyst and advisory firm that helps business and IT leaders understand, navigate, and act on digital transformation and emerging technology trends. It delivers expert insight, commentary, and advisory services that cut through hype and connect technology strategy to real business value.

Intellyx included Autonomy in their [_2025 Intellyx Digital Innovator Awards list_](https://intellyx.com/2025/12/08/announcing-the-winter-2025-intellyx-digital-innovator-award-winners/), now in its fifth year. Intellyx bestows this award on every vendor who makes it through Intellyx’s rigorous briefing selection process and delivers a successful briefing that results in coverage that year.
...
> The Autonomy platform can handle agent state persistence at scale, enabling individual agents to retain memory-based learning – a core requirement for mature agentic systems that competing platforms don’t offer.

To read the rest of the report from Intellyx: https://intellyx.com/2025/10/10/autonomy-cloud-based-ai-agent-creation-and-deployment-platform-with-vertical-scalability/

### HFS Research

HFS Research is a leading global analyst firm that covers the business, technology, and services that power modern enterprises. It helps executives, investors, and operators understand where markets are going, why they are changing, and how to act with confidence. They wrote,

> Today’s enterprise challenge has moved beyond “Can I get AI agents to work?” to “Can I run thousands of them continuously without blowing up cost, complexity, or risk?” Autonomy.Computer solves this by rethinking agentic architecture to solve for efficient scaled use of agents. The San Francisco-based firm is part of a new wave of emerging tech vendors focused on the shift from “agents that work” to agents that operate efficiently, and securely while controlling resources to deliver commercial viability.

To read the rest of the report, download the entire report from HFS Research here: https://www.hfsresearch.com/research/hfs-services-as-software-hot-tech-autonomy-computer/