...
Your Autonomy agents have built-in memory that allows them to maintain state across prompts:
...
```bash httpie
http POST \
  "https://25df35de87aa441b88f22a6c2a830a17-example001.ai.autonomy.network/agents/ef48fd1c0b8f342ef12bf679" \
