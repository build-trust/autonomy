---
title: "Models"
description: "Large language models give agents the ability to make autonomous decisions."
icon: "brain-circuit"
---
...
While agents provide a powerful framework for building autonomous applications,
you can also call models directly for simpler use cases. This is useful when you
need to make one-off completions without the full features of an agent.
