...
<Tip>
  You can find all the code for the following example [on Github](https://github.com/build-trust/autonomy/tree/develop/examples/001).
</Tip>
...
- The `autonomy.yaml` configuration file defines how to deploy a Zone in your Cluster in Autonomy AI.
...
2. Deploy the Zone into your Cluster, in Autonomy AI, based on the configuration that you specified above in `autonomy.yaml`.
3. Open two portal inlets on your workstation that connect to corresponding outlets in the `main-pod` that is running in your Zone in Autonomy AI.
...
✔ Deployed zone 01 in cluster 25df35de87aa441b88f22a6c2a830a17
  ...
  https://25df35de87aa441b88f22a6c2a830a17-01.ai.autonomy.network
...
```bash httpie
http GET \
"https://25df35de87aa441b88f22a6c2a830a17-01.ai.autonomy.network/agents"
```
...
```bash httpie
http POST \
"https://25df35de87aa441b88f22a6c2a830a17-example001.ai.autonomy.network/agents/henry" \
message="who are you?"
```
...
```bash httpie
http POST \
"https://25df35de87aa441b88f22a6c2a830a17-01.ai.autonomy.network/agents/henry?stream=true" \
