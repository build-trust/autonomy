...
**Knowledge** gives agents the ability to search a corpus of documents for
for information beyond their training data. Instead of hardcoding information
in prompts or relying solely on the model's knowledge, agents can dynamically
retrieve the most relevant information.

Knowledge uses vector embeddings to find the most relevant document chunks
