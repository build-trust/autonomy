...
will help you understand how the parts of a simple Autonomy app fit together.

Follow the initial instructions to [Get Started with Autonomy](../start/start-here#get-started). Then continue on to the following steps:
...
- _"What are the key elements of a contract?"_
- _"What is consideration in contract law?"_
- _"Explain breach of contract"_
...
This will create a private link to the logs server on localhost and display
the address `http://127.0.0.1:32101`. Open it in the browser to see streaming
