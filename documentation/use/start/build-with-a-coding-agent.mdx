...
Coding agents like Claude Code, Codex CLI, Gemini CLI, Cursor, Cline, Devin, Zed, etc. can
use Autonomy documentation to ship complete autonomous applications.

To try this:
1. Set up your favorite coding agent.
2. Follow the initial instructions to [Get Started with Autonomy](../start/start-here#get-started).
3. Give your coding agent the following prompt:
