...
- [Coding Agents: Define a custom UI](https://autonomy.computer/docs/for-coding-agents/define-a-custom-ui): For applications that need user interfaces that are more complex than what is ideal for a simple `index.html` , Autonomy apps can serve a compiled static site using FastAPI. This site can call APIs defined within the app.