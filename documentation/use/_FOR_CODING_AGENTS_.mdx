...
- [Coding Agents: Define a custom UI](https://autonomy.computer/docs/_for-coding-agents_/define-a-custom-ui): For applications that need user interfaces that are more complex than what is ideal for a simple `index.html` , Autonomy apps can serve a compiled static site using FastAPI. This site can call APIs defined within the app.