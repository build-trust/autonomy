...
The **Autonomy Framework** provides built-in APIs for Agents. See the [guide on creating and deploying a new Autonomy app](https://autonomy.computer/docs/_for-coding-agents/create-a-new-autonomy-app.mdx) for examples of how to use the built-in API endpoints.
...
- **Create custom UI**: Follow the [guide on creating custom user interfaces](https://autonomy.computer/docs/_for-coding-agents/create-custom-ui.mdx)
