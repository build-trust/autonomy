---
title: 'Define a custom UI'
description: 'For applications that need user interfaces that are more complex than what is ideal for a simple `index.html`, Autonomy apps can serve a compiled static site using FastAPI. This site can call APIs defined within the app. This file shows you how to do that.'
---
