...
icon: "rabbit"
mode: "wide"
description: "A platform-as-a-service to ship autonomous products."
---

Autonomy is a platform-as-a-service (PaaS). Use it to build and scale products that use teams of **deep work agents** to autonomously perform long and complex tasks. Each agent can plan, take notes on a filesystem, **curate context** on every turn, and delegate work to **parallel sub-agents**.
