...
class TestProviderAliases:
  ...
  def test_claude_models_available(self):
    ...
    claude_models = ["claude-sonnet-4-5", "claude-haiku-4-5", "claude-opus-4-5", "claude-sonnet-4", "claude-opus-4"]
  ...
  def test_llama_models_available(self):
    ...
    # Note: Llama models are disabled in litellm_proxy and bedrock due to infinite loop issues
    # Only available in ollama
